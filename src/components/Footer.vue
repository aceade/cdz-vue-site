    ...
    <footer>
        <div>
            <nav class="navigation">
                <!-- <ul> -->
                    <!-- Mastodon -->
                    <a href="https://mastodon.ie/@aceade" target="_blank">                            
                    ...
                    <!-- Main -->
                    <a href="https://aceade.net" title="My main site">
                        <img src="/images/aceade-label.jpg" id="mainSiteLink" alt="My main site">
                    </a>
